		...
		return (
			<div>
				<ol>
					...
					<li>
						Inside the ValidationComponent, either output "Text too short" orr
						"Text long enough" depending on the text length (e.g. take 5 as
						minimum length)
					</li>
					<li>
						Create another component (=> ChartComponent) and style it as an
						inline box (=> display: inline-block, padding: 16px, text-align:
						center, margin: 16px, border: 1px solid black).
					</li>
					<li>
						Render a list of ChartComponents where each ChartComponent receives
						a different letter of the entered text (in the initial input field)
						as a prop.
					</li>
					<li>
						When you click a ChartComponent, it should be removed from the
						entered text.
					</li>
				</ol>
