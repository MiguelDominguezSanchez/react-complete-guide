		...
		return (
			<div className='App'>
				<ol>
					...
					<li>
						Add a state to the App component (=> the username) and pass the
					...
					<li>
						Ensure that the new input entered byy the user overwrites the old
					...
					<li>
						Add styling of your choice to yorr components / elements in the
